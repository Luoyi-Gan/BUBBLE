...
因此，90% 的系统边界无法由题面唯一确定；以下为在该信息缺口下的可复核建模解释。
...
**队长已确认（2026-09-10）：** 因题面以单个“90%”描述“储能设备的充放电效率”，且未分别给出充、放电两个数值，Q1 将其视为公共母线侧储能整体的往返效率，令 \(\eta_{rt}=0.90\)。在无单程效率数据时，为保持对称简化，取 \(\eta_c=\eta_d=\sqrt{0.90}\)。
...
4. **已确认：** 口径 A 为主方案，口径 B 为敏感性方案；`docs/specs/q1.md` 已同步。
