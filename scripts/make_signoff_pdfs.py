...
CAPTAIN = {
    "title": "队长（AI）签收单",
    "subtitle": "CUMCM 2026 · 技术总负责 · Codex 规格终审 · Cursor 调度 · 9.11 16:00–24:00 离场",
    ...
    "sections": [
        ...
        ("9.11（周四）· 搬家 + 酒店", "中 13:30–16:00 ⚠️ 最后窗口", [
        ...
        ], "Q2 可跑 · Q3 规格已确认 · 交接单已宣读", "16:00 离场"),
        ("9.11（周四）", "晚 16:00–24:00", [
            "本时段离场 — 无队长任务",
        ], "—", "24:00 回归"),
        ("9.11（周四）", "深夜 24:00–02:00", [
        ...
        ("9.13（周六）· 提交", "早 08:00–12:00", [
            "08:00–10:00 独立终审，列问题清单",
            "核数：output/ 与论文最终一致",
            "打包支撑材料（代码 + 数据说明 + AI 声明 PDF）",
            "10:00 前把 blocker 清完",
        ], "支撑材料包"),
        ("9.13（周六）· 提交", "午后 13:00–15:00", [
...
CODEX = {
    ...
    "sections": [
        ...
        ("9.11（周四）· 搬家 + 酒店", "早 08:00–10:00", [
            "响应队长：修订 Q2 规格",
            "起草 q3.md 草稿（队长 10:00 前需带走）",
        ], "q2 修订 · q3 草稿"),
        ("9.11（周四）· 搬家 + 酒店", "中 13:30–16:00", [
            "15:30 前配合队长确认 q3.md（可简化版）",
            "演示会前：对 Q1/Q2 output/ 做快速逻辑审阅",
            "列出 16:00–24:00 风险点（写入交接单「Codex 待办」）",
        ], "q3.md 待队长确认 · 离场前审阅摘要"),
        ("9.11（周四）· 搬家 + 酒店", "晚 16:00–24:00", [
