...
\paragraph{Q4-3 当前状态。}Q4-3 全年链路已完成：365 日物理审计全部通过，跨日 SOC 连续；两日信息集探针 \texttt{all\_pass=true}；\texttt{q4\_3\_cost\_ledger.csv} 逐时段重算与 \texttt{q4\_3\_warmup\_daily.csv} 一致。正式工作簿 \texttt{result4-3.xlsx} 已按 334 日题设区间导出；与 Q3 固定价主结论的比较在正文中仅作\textbf{价格机制对照}，不作同口径优劣排序。
