...
\end{equation}
由同一历史日产生的负荷与光伏残差分别记为 $r^L_{j,t}=L_{j,t}-\widehat L_{j,t}$、$r^P_{j,t}=P_{j,t}-\widehat P_{j,t}$。在最近至多 $28$ 个完整残差日中用 PAM/K-medoids 选取 $K=8$ 条代表轨迹；第 $k$ 条轨迹的权重为其所属簇的样本占比 $\pi_k$。
