...
\text{s.t.}\quad q_{d,t}&\ge R_{d,t}(\alpha), &&\quad t=1,\ldots,T,\nonumber\\[-2pt]
0&\le x_{d,t}\le q_{d,t}, &&\quad t=1,\ldots,T,\nonumber\\[-2pt]
x_{d,t}+e_{d,t}+\widehat P_{d,t}-w_{d,t}+r_{d,t}&=\widehat L_{d,t}+c_{d,t}, &&\quad t=1,\ldots,T,\label{eq:q2-balance}\\
E_{d,t}&=E_{d,t-1}+\eta_cc_{d,t}-r_{d,t}/\eta_d, &&\quad t=1,\ldots,T,\label{eq:q2-soc}\\
0&\le c_{d,t},r_{d,t}\le5000\Delta t, &&\quad t=1,\ldots,T,\nonumber\\[-2pt]
0&\le w_{d,t}\le\widehat P_{d,t},\quad 0\le e_{d,t}, &&\quad t=1,\ldots,T,\nonumber\\[-2pt]
1200&\le E_{d,t}\le10800, &&\quad \eta_c=\eta_d=\sqrt{0.9}.\nonumber
\end{alignat}
式中 $c,r,w,E$ 分别为公共母线侧充电、放电、弃光和时段末储电量。$V_{d+1}(\cdot)$ 为按次日因果预测构造的 $48$ 小时终端价值项，只衡量日末能量的机会成本，不提前计入下一日账单。
